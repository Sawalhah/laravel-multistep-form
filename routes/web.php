...
Route::get('/products/create-step2', 'ProductController@createStep2')->middleware('CheckStep');
...
Route::get('/products/create-step3', 'ProductController@createStep3')->middleware('CheckStep');
